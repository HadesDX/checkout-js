...
const MolliePaymentMethod: FunctionComponent<MolliePaymentMethodsProps & WithInjectedHostedCreditCardFieldsetProps > = ({
    ...
    function validateInstrument(shouldShowNumber: boolean, selectedInstrument: CardInstrument) {
        if (selectedInstrument && selectedInstrument.trustedShippingAddress && !shouldShowNumber) {
            return;
        }
